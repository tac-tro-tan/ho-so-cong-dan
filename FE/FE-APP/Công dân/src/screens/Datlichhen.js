        ...
        return(
            ...
            <View style ={styles.form}>
                <View style={styles.box_text}>
                    <Text style ={{ fontSize: 38, color:"#FF4500", marginTop: 15}}>ĐẶT LỊCH HẸN</Text>
                    <View style ={styles.line}></View>
                </View>
                <Text style = {{ marginLeft: 20, marginBottom: 5, color:"black"}}>Vấn đề cần giải quyết:</Text>
                <View 
                ...
                <Text style = {{ marginLeft: 20, marginBottom: 5, color:"black"}}>Ghi chú:</Text>
                <TextInput
